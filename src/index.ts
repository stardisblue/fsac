...
export class CircleRbush extends Rbush<Ref<Circle>> {
  toBBox(item: Ref<Circle>) {
    return circleBbox(item.v);
  }

  compareMinX(a: Ref<Circle>, b: Ref<Circle>) {
    return a.v.x - a.v.r - (b.v.x - b.v.r);
  }

  compareMinY(a: Ref<Circle>, b: Ref<Circle>) {
